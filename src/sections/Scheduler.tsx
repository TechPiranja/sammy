...
const Scheduler = ({ platforms, scheduledPosts, onCreatePost }: Props) => {
  ...
  const [description, setDescription] = useState(
    "Upload short video with description for IG/YouTube/TikTok.",
  );
    ...
    <Stack spacing={3}>
      <Paper sx={{ p: { xs: 2.5, md: 3 } }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Title is required for YouTube. Thumbnail is optional for platforms
          that support it. All calls run through your backend via Next.js API
          routes.
        </Typography>
      </Paper>
          ...
          >
            <Stack spacing={1}>
              ...
              <Select
                ...
                onChange={(e) =>
                  setSelectedPlatforms(e.target.value as PlatformId[])
                }
